...
import 'package:example_project/item_checkout_page.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: FilledButton(
          ...
          child: Text("총 ${numberFormat.format(totalPrice)} 원 결제 하기")),
      ),
    );  
  }

  Widget basketContainer({required int productNo, required String productName, required String productImageUrl, required double price, required int quantity}){
    return Container(
