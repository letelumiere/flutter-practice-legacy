...
import 'package:example_project/item_details_page.dart';
import 'package:example_project/models/product.dart';
...
class _ItemListPageState extends State<ItemListPage> {
  ...
  Widget productContainer({required int productNo, required String productName, required String productImageUrl, required double price}){
